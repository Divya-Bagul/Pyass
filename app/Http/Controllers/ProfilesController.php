...
class ProfilesController extends Controller
{
        ...
        //return view('profiles.show')->with($data);
         if ($user->isAdmin()) {
            return view('profiles.show')->with($data);
               ...
               return view('profiles.user_show')->with($data);
       }
    }
       ...
       // return view('profiles.edit')->with($data);
        if ($user->isAdmin()) {
            return view('profiles.edit')->with($data);
               ...
               return view('profiles.user_edit')->with($data);
        }
    }
    ...
    public function updateUserAccount(Request $request, $id)
    {
        ...
        $user->balance = strip_tags($request->input('balance'));

        $user->due = strip_tags($request->input('due'));
    ...
    function updateUserAccountData(Request $req)
    {
     ...
     Alert::success('Success', 'Your Profle is Updated');
     return back();
       // return back()->with('msg',"Youre Profile Upadeted");
    }
    /**
