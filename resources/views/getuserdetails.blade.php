        ...
        <div class="card col-12">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input type="date" id="from" name ="from" placeholder="MM/DD/YYYY"  value="<?php echo date("Y-m-d"); ?>"/> 
                                <input type="date" id="to" name="to" placeholder="MM/DD/YYYY"  value="<?php echo date("Y-m-d"); ?>"/>
                            </div>
                              <br>
