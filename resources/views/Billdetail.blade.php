    ...
    <div class="container-fluid">
        <div class="row">
            ...
            @foreach($products as $order)
              ...
              <br>
              @if($loop->first)
              <div class="col-sm-12 col-lg-12"><center>{{$order->name}}'s Bill </center></div>
              @endif
                    ...
                    <div class="col-sm-12 table-responsive-sm">
                            ...
                            <table class="table" >
                                    ...
                                    <div class="col-sm-12 col-lg-6"><a href="{{url('getBilling')}}" class="btn btn-secondary mt-2">Go Back</a></div>
