...
return [
    ...
    'buttons' => [
        ...
        'delete'        => '<i class="fa fa-trash" aria-hidden="true"></i>  <span class="hidden-xs hidden-sm">Apagar</span><span class="hidden-xs hidden-sm hidden-md"> Usuário</span>',
        ...
        'delete-user'   => '<i class="fa fa-trash" aria-hidden="true"></i>  <span class="hidden-xs">Apagar</span><span class="hidden-xs"> Usuário</span>',
