...
return [
    ...
    'buttons' => [
        'create-new'    => 'New User',
        'delete'        => '<i class="fa fa-trash" aria-hidden="true"></i>  <span class="hidden-xs hidden-sm">Delete</span><span class="hidden-xs hidden-sm hidden-md"> User</span>',
        ...
        'edit'          => '</i><span class="hidden-xs hidden-sm">Edit</span><span class="hidden-xs hidden-sm hidden-md"> User</span>',
        ...
        'delete-user'   => '<i class="fa fa-trash" aria-hidden="true"></i>  <span class="hidden-xs">Delete</span><span class="hidden-xs"> User</span>',
        'edit-user'     => ' <span class="hidden-xs">Edit</span><span class="hidden-xs"> User</span>',
    ],
